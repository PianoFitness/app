...
echo ""
echo "🔍 Finding iPhone Pro Max simulator..."
...
if [ -z "$DEVICE_ID" ]; then
    echo "❌ Could not find any iPhone Pro Max simulator"
    echo ""
...
echo "    xcrun simctl io $DEVICE_ID screenshot screenshots/iphone-\$(date +%Y%m%d-%H%M%S).png"
echo ""
